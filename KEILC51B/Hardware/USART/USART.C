...
*历史版本 ： --
***********************************************************************************************/
void MasterUsart_SendBuf(Slaver_State rtn_state)
{
	MasterUsart_SendByte(0x80  | (rtn_state.WARN<<4)| ((rtn_state.DETB>>2)));
	MasterUsart_SendByte(((rtn_state.DETB&0x03)<<6) | rtn_state.DETC );
}
/***********************************************************************************************
